...
Public Sub Validate_Passing_SSN()
    ' Success: normal SSN
    Assert.IsTrue Validation.validate_social("055505549")
End Sub

'@TestMethod
Public Sub Validate_Passing_SSN_With_Dashes()
    ' Success: normal SSN with dashes
    Assert.IsTrue Validation.validate_social("055-50-5549")
End Sub
...
Public Sub Validate_Failing_SSN_Too_Many()
    ...
    Assert.IsFalse Validation.validate_social("0555055499")
    Assert.IsFalse Validation.validate_social("055-50-554910")
End Sub

'@TestMethod
Public Sub Validate_Failing_SSN_Too_Few()
    ' Failure: too few characters
    Assert.IsFalse Validation.validate_social("055-50-554")
    Assert.IsFalse Validation.validate_social("055-50-55")
...
Public Sub Validate_Failing_SSN_Too_Few_With_Dashes()
    ...
    Assert.IsFalse Validation.validate_social("055-50-55")
    Assert.IsFalse Validation.validate_social("055 50 55")
    Assert.IsFalse Validation.validate_social(" 0555055 ")
End Sub
...
Public Sub Validate_Failing_SSN_NonDigits()
    ...
    Assert.IsFalse Validation.validate_social("@055-21-2345")
    Assert.IsFalse Validation.validate_social("055-21-2345/")
